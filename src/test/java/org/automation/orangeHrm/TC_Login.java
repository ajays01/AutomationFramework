...
import org.automation.pages.orangeHrm.LoginPage;
...
public class TC_Login extends orangeHrmBase {
    ...
    @Test(dataProvider = "TC_LoginData")
    public void TC_LoginTest(String sINo, String caseId ) throws IOException {
        //Dataset++;
        ...
        obj_LoginPage.launchApplication(Param.getProperty("orangeHrmUrl"));
        PageFunctions.takeSnapShotWithText(driver,caseId,"");
        obj_LoginPage.login(Param.getProperty("orangeHrmUserName"), Param.getProperty("orangeHrmUserPassword"),caseId );
