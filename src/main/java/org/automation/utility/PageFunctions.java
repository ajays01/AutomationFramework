...
public class PageFunctions extends BasePage {
    ...
    public static void comparePDF( ) throws IOException {
        String pdf1 = "pdf1.pdf";
        String pdf2 = "pdf2.pdf";
        PDFUtil pdfUtil = new PDFUtil();
        pdfUtil.setCompareMode(CompareMode.VISUAL_MODE);
        pdfUtil.highlightPdfDifference(true);
        pdfUtil.setImageDestinationPath("diffImages");
        boolean result = pdfUtil.compare(pdf1, pdf2);
        System.out.println("PDFs are e qual: " + result);
    }
